...
INSERT INTO Albums(album_name, artist_name, duration, number_of_songs)
VALUES ('CHROMAKOPIA', 'Tyler, The Creator', '53min', 14),
('IGOR', 'Tyler, The Creator', '39min 46sec', 12),
('Flower Boy', 'Tyler, The Creator', '46min 39sec', 14),
('Mezzanine', 'Massive Attack', '1hr 3min', 11),
('Rumours', 'Fleetwood Mac', '39min 58sec', 11),
('Tapestry', 'Carol King', '44min 33sec', 12),
('What''s Going On', 'Marvin Gaye', '35min 32sec', 9),
('Hounds of Love', 'Kate Bush', '47min 22sec', 12),
('The Sensual World', 'Kate Bush', '42min 3sec', 10),
('The Dreaming', 'Kate Bush', '43min 21sec', 10),
('Pieces of a Man', 'Gil Scott-Heron', '1hr', 14),
('Stories From The City, Stories From The Sea', 'PJ Harvey', '47min 12sec', 12),
('The Rise and Fall of Ziggy Stardust and the Spiders from Mars', 'David Bowie', '38min 39sec', 11),
('Young Americans', 'David Bowie', '40min 52sec', 8),
('Aladdin Sane', 'David Bowie', '41min 45sec', 10),
('HIT ME HARD AND SOFT', 'Billie Eilish', '43min 50sec', 10),
('Grace', 'Jeff Buckley', '57min 3sec', 11),
('Master of Puppets', 'Metallica', '54min 47sec', 8),
('Ride The Lightning', 'Metallica', '47min 25sec', 8),
('Thriller', 'Michael Jackson', '42min 21sec', 9),
('Bad', 'Michael Jackson', '48min 10sec', 11),
('Are You Experienced', 'Jimi Hendrix', '1hr', 17),
('The Miseducation of Lauryn Hill', 'Ms. Lauryn Hill' , '1hr 17min', 16),
('Remain in Light', 'Talking Heads', '40min 3sec', 8),
('Debut', 'Björk', '48min 21sec', 11),
('Homogenic', 'Björk', '43min 32sec', 10),
('The Rise and Fall of a Midwest Princess', 'Chappell Roan', '49min 8sec', 14),
('Puberty 2', 'Mitski', '31min 25sec', 11),
('Be the Cowboy', 'Mitski', '32min 34sec', 14),
('How To Be A Human Being', 'Glass Animals' ,'43min 13sec', 11),
('OK Computer', 'Radiohead', '53min 41sec', 12),
('That''s Life', 'Frank Sinatra', '25min 33sec', 10),
('Heaven or Las Vegas', 'Cocteau Twins', '37min 24sec', 10),
('The Dark Side of the Moon', 'Pink Floyd', '42min 53sec', 10),
('Animals', 'Pink Floyd', '41min 41sec', 5),
('The Wall', 'Pink Floyd', '1hr 20min', 26),
('Depression Cherry', 'Beach House', '44min 49sec', 9),
('A Night At The Opera', 'Queen', '43min 4sec', 12),
('Pet Sounds', 'The Beach Boys', '37min 21sec', 13),
('Rebel Yell', 'Billy Idol', '38min 22sec', 9),
('Back To Black', 'Amy Winehouse', '34min 46sec', 11);
